import { Paper, Skeleton, Stack, Table, TableBody, TableCell, TableHead, TableRow } from '@mui/material';
            ...
            <Stack spacing={3} alignItems="center" sx={{ width: '100%', maxWidth: 1200, margin: '0 auto', padding: 3 }}>
                ...
                <Paper sx={{ width: '100%', borderRadius: 2, boxShadow: 3 }}>
                    <Table>
                        <TableHead>
                            <TableRow>
                                {['Название', 'Контактное лицо', 'Телефон', 'Email', 'Адрес', 'Индустрия', ''].map((_, index) => (
                                    <TableCell key={index}>
